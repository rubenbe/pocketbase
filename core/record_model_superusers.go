...
func (app *BaseApp) registerSuperuserHooks(allowSuperUser bool) {
	fmt.Println("REGISTERING", allowSuperUser);
	AllowSuperUser = allowSuperUser
...
func (m *Record) IsSuperuser() bool {
	return m.Collection().Name == CollectionNameSuperusers && AllowSuperUser == true
}
